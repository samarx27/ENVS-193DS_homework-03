...
Both tests (Pearson's Correlation and Spearman's Correlation) would have led me to make the same decision (rejecting the null hypothesis) because the correlation coefficients are similar values that are close to 0.6 and indicate a moderate strength relationship.
...
![](images/Screenshot%202026-03-04%20at%208.50.37%20PM.png) ![Alt text](path/to/Images/Screenshot%202026-03-04%20at%208.50.37%20PM.png) \## c. ![Alt text](path/to/Images/Screenshot%202026-03-04%20at%208.51.19%20PM.png)
