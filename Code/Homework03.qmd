...
I would say the authors did well in representing their statistics in figures. Though these figures do not represent the ANOVA test specifically, the adequately represent the linear regression and selectivity coefficients, as the x- and y- axes are in logical positions and the figures do show the underlying data in their model predictions. However, these figures do not include summary statistics. 
